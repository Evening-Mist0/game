...
/// </summary>
public abstract class BaseCardAI : MonoBehaviour
{
    #region 1. 基础标识属性
    [Header("卡牌基础配置")]
    [Tooltip("卡牌唯一ID")]
    ...
    public abstract BaseCardAI OnCombineCard(BaseCardAI partnerCard);
    ...
    public bool IsLegalCombine(BaseCardAI otherCard)
    {
