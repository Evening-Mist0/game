    ...
    public override void EnterState()
    {
        ...
        if(info != null)
        {
            ...
            else
            {
                ...
                {
                    //realRoundCount = MonsterCreater.Instance.CreateOneMonsterAt(DataCenter.Instance.monsterResNameData.Monster_Fire03_MoltenGuard, GridMgr.Instance.gridWideCount - 1, roundCount);
